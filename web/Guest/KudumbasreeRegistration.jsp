<%-- 
    Document   : Kudumbasree
    Created on : 29 Feb, 2024, 10:32:50 AM
    Author     : sreel
--%>
...
<html>
    <head>
        ...
        <title>KudumbasreeReg</title>
    </head>
    <%@include file="Head.jsp" %>
    <body>

        <form enctype="multipart/form-data" method="post"action="../Assets/ActionPages/KudumbasreeUploadAction.jsp">
            <table border="1">
                <tr>
                    <td>Name</td>
