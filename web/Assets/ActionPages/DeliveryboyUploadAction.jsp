...
//checking if request cotains multipart data
            ...
            if (isMultipart) {
                ...
                while (itr.hasNext())//checking if there is any value in the position like rs.next()
                {
                    ...
                    String InsQry = "INSERT INTO tbl_deliveryboy( deliveryboy_name,deliveryboy_contact,deliveryboy_address,deliveryboy_email,deliveryboy_photo,deliveryboy_proof,deliveryboy_password,deliveryboy_status,place_id)"
