...
//checking if request cotains multipart data
                ...
                while (itr.hasNext())//checking if there is any value in the position like rs.next()
                {
                    ...
                    } else//when it is an image or multipart
                    {
                        ...
                        if (field_name.equals("filephoto"))//write the name of image here it is img_product
                        {
                            ...
                            photo = "HotelPhoto_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                    ...
                    if (field_name.equals("filename"))//write the name of image here it is img_product
                        {
                            ...
                            proof = "HotelProof_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                            //creating a file object
                    ...
                    String InsQry = "INSERT INTO tbl_hotel( hotel_name, hotel_contact, hotel_address,hotel_email, hotel_photo,hotel_proof, hotel_password, hotel_status,place_id)"
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Guest/HotelRegistration.jsp'
