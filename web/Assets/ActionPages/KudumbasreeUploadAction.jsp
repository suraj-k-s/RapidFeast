...
//checking if request cotains multipart data
                ...
                while (itr.hasNext())//checking if there is any value in the position like rs.next()
                {
                    ...
                    } else//when it is an image or multipart
                    {
                        ...
                        if (field_name.equals("filephoto"))//write the name of image here it is img_product
                        {
                            ...
                            photo = "KudumbasreePhoto_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                     ...
                     if (field_name.equals("filename"))//write the name of image here it is img_product
                        {
                            String ext = file_name.substring(file_name.lastIndexOf("."));//means the extension is stored to variable ext
                            //setting path to store image
                            File proj_path = new File(config.getServletContext().getRealPath("/"));
                            ...
                            proof = "KudumbasreeProof_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                            //creating a file object
                  ...
                  String InsQry = "INSERT INTO tbl_kudumbasree( kudumbasree_name, kudumbasree_contact, kudumbasree_address,kudumbasree_email,kudumbasree_photo,kudumbasree_proof,kudumbasree_password,kudumbasree_status,place_id)"
                            + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + photo + "','" + proof + "','" + value[4]  + "','" + value[5] + "','"+ value[7]+"')";
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Guest/KudumbasreeRegistration.jsp'
