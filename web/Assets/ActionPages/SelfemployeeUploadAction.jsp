                ...
                while (itr.hasNext())//checking if there is any value in the position like rs.next()
                {
                    ...
                    } else//when it is an image or multipart
                    {
                        ...
                        if (field_name.equals("filephoto"))//write the name of image here it is img_product
                        {
                            ...
                            photo = "SelfemployeePhoto_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                    ...
                    if (field_name.equals("filename"))//write the name of image here it is img_product
                        {
                            ...
                            proof = "SelfemployeeProof_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                            //creating a file object
                    ...
                    String InsQry = "INSERT INTO tbl_selfemployee( selfemployee_name,selfemployee_contact,selfemployee_address,selfemployee_email,selfemployee_photo,selfemployee_proof,selfemployee_password,selfemployee_status, place_id)"
