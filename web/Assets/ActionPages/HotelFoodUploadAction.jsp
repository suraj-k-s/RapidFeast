...
//checking if request cotains multipart data
    ...
    if (isMultipart) {
        ...
        String InsQry = "INSERT INTO tbl_food( food_name,food_image, food_details, food_rate,hotel_id,subcategory_id)"
                + "values('" + value[0] + "','" + photo + "','" + value[1] + "','" + value[2] + "','" + session.getAttribute("hid") + "','" + value[4] + "')";
...
<script type="text/javascript">
    ...
    setTimeout(function() {
        window.location.href = '../../Hotel/Food.jsp'
