<%-- 
    Document   : FoodUploadAction
    Created on : 19 Mar, 2024, 12:21:02 PM
    Author     : sreel
--%>
...
//checking if request cotains multipart data
    ...
    if (isMultipart) {
        ...
        while (itr.hasNext())//checking if there is any value in the position like rs.next()
        {
            ...
            } else//when it is an image or multipart
            {
                ...
                if (field_name.equals("filephoto"))//write the name of image here it is img_product
                {
                    ...
                    photo = "FoodPhoto_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
        ...
        String InsQry = "INSERT INTO tbl_food( food_name,food_image, food_details, food_rate,selfemployee_id,subcategory_id)"
                + "values('" + value[0] + "','" + photo + "','" + value[1] + "','" + value[2] + "','" + session.getAttribute("sid") + "','" + value[4] + "')";
...
<script type="text/javascript">
    ...
    setTimeout(function() {
        window.location.href = '../../SelfEmployee/Food.jsp'
