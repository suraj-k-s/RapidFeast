    ...
    <body>
        <%
            if (request.getParameter("btn_save") != null) {
                ...
                rs.next();
                String dbpassword = rs.getString("kudumbasree_password");
                ...
                if (dbpassword.equals(CurrentPassword)) {
                    if (NewPassword.equals(Repassword)) {
                        String updateQuery = "update tbl_kudumbasree SET kudumbasree_password='" + request.getParameter("txt_newpassword") + "' where kudumbasree_id='" + session.getAttribute("kid") + "'";
