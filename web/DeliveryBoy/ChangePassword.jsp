    ...
    <body>
        <%
            if (request.getParameter("btn_save") != null) {
                ...
                rs.next();
                String dbpassword = rs.getString("deliveryboy_password");
                ...
                if (dbpassword.equals(CurrentPassword)) {
                    if (NewPassword.equals(Repassword)) {
                        String updateQuery = "update tbl_deliveryboy SET deliveryboy_password='" + request.getParameter("txt_newpassword") + "' where deliveryboy_id='" + session.getAttribute("did") + "'";
