...
<html>
    ...
    <%
        if (request.getParameter("id") != null) {
            ...
            String upa = "update tbl_booking set deliveryboy_id='" + session.getAttribute("did") + "' where boooking_id='" + request.getParameter("bid") + "'";
    ...
    <body>
        ...
        <table align='center' border="1" width="50%" >
            ...
            <%                int i = 0;
                String selQry = "select * from tbl_booking b inner join tbl_cart c on c.booking_id=b.booking_id inner join tbl_user u on u.user_id=b.user_id inner join tbl_food p on p.food_id=c.food_id where booking_status=2";
            ...
            <tr>
                ...
                <td>  <a href="ViewAllOrders.jsp?id=<%=rs.getString("cart_id")%>&bid=<%=rs.getString("booking_id")%>&status=3">Pick Up</a>
                </td>
            </tr>         
            <%                }
