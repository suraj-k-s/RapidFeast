    ...
    <body>
        <%
            if (request.getParameter("btn_save") != null) {
                ...
                rs.next();
                String dbpassword = rs.getString("hotel_password");
                ...
                if (dbpassword.equals(CurrentPassword)) {
                    if (NewPassword.equals(Repassword)) {
                        String updateQuery = "update tbl_hotel SET hotel_password='" + request.getParameter("txt_newpassword") + "' where hotel_id='" + session.getAttribute("hid") + "'";
