...
<html>
    ...
    <body>
        ...
        <table align='center' border="1" width="50%" >
            ...
            <%                int i = 0;
                String selQry = "select * from tbl_booking b inner join tbl_cart c on c.booking_id=b.booking_id inner join tbl_user u on u.user_id=b.user_id inner join tbl_food p on p.food_id=c.food_id where selfemployee_id='" + session.getAttribute("sid") + "' and booking_status>0";
            ...
            <tr>
                ...
                <td><%
                    ...
                    %>
                    Payment Completed <a href="ViewBooking.jsp?id=<%=rs.getString("cart_id")%>&status=2">Pack Food</a>
                    <%
