...
<html>
    ...
    <body>
        ...
        <table border="1">
            ...
            <%
                int j = 0;
                String seQry = "select* from tbl_food f inner join tbl_subcategory sc on sc.subcategory_id=f.subcategory_id inner join tbl_category c on c.category_id=sc.category_id where selfemployee_id='"+session.getAttribute("sid")+"'";
