        ...
        <form method="post">
            <div class="shopping-cart" style="margin-top: 50px">
                ...
                <%               
                    ...
                    while (rs.next()) {
                        String selProduct = "select * from tbl_food where food_id='" + rs.getString("food_id") + "'";
                ...
                <div class="product">
                    <div class="product-image">
                        <img
                            src="../Assets/Files/<%=rsProduct.getString("food_image")%>"
                            />
                    </div>
                    <div class="product-details">
                        <div class="product-title"><%=rsProduct.getString("food_name")%></div>
                        <p class="product-description">
                            <%=rsProduct.getString("food_details")%>
                        </p>
                    </div>
                    <div class="product-price"><%=rsProduct.getString("food_rate")%></div>
                    <div class="product-quantity">
                        <input alt="<%=rs.getString("cart_id")%>" type="number" value="<%=rs.getString("cart_qty")%>" min="1" max="10"/>
                    </div>
                    ...
                    <div class="product-line-price">
                        <%
                            float pr = Float.parseFloat(rsProduct.getString("food_rate"));
