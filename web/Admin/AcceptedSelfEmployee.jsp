...
<html lang="en" >
    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_selfemployee c inner join tbl_place p on p.place_id=c.place_id inner join tbl_district d on d.district_id=p.district_id where selfemployee_status='1'";
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="NewSelfEmployee.jsp?rid=<%=rs.getString("selfemployee_id")%>">
                            <img src="../Assets/remove.png"  width="25" height="25">
                        </a>
                    </td>
                </tr>
                <%
