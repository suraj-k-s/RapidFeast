...
<html lang="en" >
    ...
    <%      
        if (request.getParameter("aid") != null) {
                ...
                String upQry = "update tbl_selfemployee set selfemployee_status='1' where selfemployee_id='" + request.getParameter("aid") + "'";
        ...
        if (request.getParameter("rid") != null) {
                ...
                String upQry = "update tbl_selfemployee set selfemployee_status='2' where selfemployee_id='" + request.getParameter("rid") + "'";
                if (con.executeCommand(upQry)) {
    ...
    %>
    <body>
        <h1 align="center" id="heading">SELF EMPLOYEE Data</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_selfemployee c inner join tbl_place p on p.place_id=c.place_id inner join tbl_district d on d.district_id=p.district_id where selfemployee_status='0'";
                ...
                <tr>
                    <td><%=i%></td>
                    <td><%=rs.getString("selfempoyee_name")%></td>
                    <td><%=rs.getString("district_name")%></td>
                    <td><%=rs.getString("place_name")%></td>
                    <td><%=rs.getString("selfemployee_contact")%></td>
                    <td><%=rs.getString("selfemployee_email")%></td>
                    <td align="center">
                        <a href="NewSelfEmployee.jsp?aid=<%=rs.getString("selfemployee_id")%>"><img src="../Assets/check.png" width="25" height="25"></a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="NewSelfEmployee.jsp?rid=<%=rs.getString("selfemployee_id")%>"><img src="../Assets/remove.png"  width="25" height="25"></a>
                    </td>
                </tr>
                <%
                    }
