...
<nav class="sidebar">
    ...
    <ul id="sidebar_menu">
        ...
        <li class="">
            ...
            <ul>
                <li><a href="NewHotelList.jsp">New Hotel List</a></li>
                <li><a href="AcceptedHotelList.jsp">Accepted Hotel List</a></li>
                <li><a href="RejectedHotelList.jsp">Rejected Hotel List</a></li>
            </ul>
        </li>
        <li class="side_menu_title">
