...
<html lang="en" >
    ...
    <%      
        if (request.getParameter("aid") != null) {
                ...
                String upQry = "update tbl_kudumbasree set kudumbasree_status='1' where kudumbasree_id='" + request.getParameter("aid") + "'";
        ...
        if (request.getParameter("rid") != null) {
                ...
                String upQry = "update tbl_kudumbasree set kudumbasree_status='2' where kudumbasree_id='" + request.getParameter("rid") + "'";
                if (con.executeCommand(upQry)) {
    ...
    %>
    <body>
        <h1 align="center" id="heading">Kudumbasree Data</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_kudumbasree c inner join tbl_place p on p.place_id=c.place_id inner join tbl_district d on d.district_id=p.district_id where kudumbasree_status='0'";
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="NewKudumbasree.jsp?aid=<%=rs.getString("kudumbasree_id")%>"><img src="../Assets/check.png" width="25" height="25"></a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="NewKudumbasree.jsp?rid=<%=rs.getString("kudumbasree_id")%>"><img src="../Assets/remove.png"  width="25" height="25"></a>
                    </td>
                </tr>
                <%
                    }
